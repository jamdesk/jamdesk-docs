...
description: Use this guide to manage project settings such as name, repository, domains, and build options. Follow the steps here and use the related articles for deeper.
---

Use this guide to manage project settings such as name, repository, domains, and build options. It explains where to find each setting and how changes affect your documentation site. Use it when you are managing your account or projects and want to understand the impact before you confirm changes. Related articles at the end point to deeper setup and troubleshooting guidance.
