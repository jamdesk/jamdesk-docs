...
Configure your project's display name, connected repository, branch, environment variables, custom domain, and danger zone options from the Settings page in the dashboard. Each section below explains what a setting controls and how changing it affects your live site.
