...
description: Transfer ownership when a project needs a new admin or team lead. Follow the steps here and use the related articles for deeper setup or troubleshooting.
---

Transfer ownership when a project needs a new admin or team lead. This guide explains prerequisites, the transfer flow, and how access changes for the new owner. Use it when you are managing your account or projects and want to understand the impact before you confirm changes. Related articles at the end point to deeper setup and troubleshooting guidance.
