...
description: "Guides for managing your Jamdesk account, projects, builds, billing, custom domains, and integrations. Browse by topic or search for specific help articles."
---
...
<Columns cols={3}>
  ...
  <Card title="Builds" icon="hammer" href="/builds/triggering">
    Trigger builds, monitor progress, and diagnose failures
  </Card>
  <Card title="Analytics" icon="chart-line" href="/setup/analytics-overview">
  ...
  <Card title="Domains" icon="globe" href="/deploy/custom-domains">
