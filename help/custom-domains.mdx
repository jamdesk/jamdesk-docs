...
description: Set up and troubleshoot custom domains for your documentation site
---
...
You configure a proxy (Cloudflare, Vercel, nginx, etc.) to forward `/docs/*` requests to Jamdesk. See [Hosting at /docs Subpath](/deploy/overview) for setup guides.
