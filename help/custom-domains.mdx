...
description: Custom domains put your docs on your own brand. This guide walks through adding a domain, verifying DNS, and solving the most common setup issues.
---

Custom domains put your docs on your own brand. This guide walks through adding a domain, verifying DNS, and solving the most common setup issues. It includes verification tips and common DNS mistakes to check before you contact support. Use it whether you are adding a subdomain or hosting at a /docs path.
