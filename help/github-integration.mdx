...
description: Jamdesk uses two GitHub connections - a GitHub App for repository access and a personal account link for build attribution. Learn when to use each.
---
