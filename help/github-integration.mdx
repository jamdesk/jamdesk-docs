...
description: Jamdesk uses two complementary GitHub connections that serve different purposes. Follow the steps here and use the related articles for deeper setup or.
---
...
If the GitHub popup doesn't open, your browser may have blocked it. Look for a popup blocker icon in your address bar and allow popups from Jamdesk. Alternatively, use the "Enter ID manually" option.
