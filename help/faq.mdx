...
<AccordionGroup>
  ...
  <Accordion title="Can readers log in with their own account instead of a shared password?">
    Yes, on Enterprise plans. Single Sign-On lets readers authenticate against your identity provider (Okta, Google Workspace, Azure AD, etc.) with no shared passwords, a full audit trail, and instant deprovisioning. See [SSO](/setup/sso) or [contact Enterprise sales](https://www.jamdesk.com/pricing).
  </Accordion>
