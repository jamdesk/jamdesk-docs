...
Every build moves through a defined set of phases from queued to live. Below you will find what each phase does, how to read the build log, and where to check status and history in the dashboard.
