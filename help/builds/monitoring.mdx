...
description: Monitor builds to understand progress, phases, and failures. This article shows where to view build status, how to read the timeline, and what each phase means.
---

Monitor builds to understand progress, phases, and failures. This article shows where to view build status, how to read the timeline, and what each phase means. Follow the checks in order to isolate the issue, then use the fixes or contact support if the problem persists. Screens in the dashboard may vary slightly by plan, but the steps are the same.
