...
description: Track build progress and understand the build phases
---

Monitor your builds in real-time from the dashboard. Each build progresses through several phases.
