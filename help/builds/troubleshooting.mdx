...
When a build fails, start by checking the error message in the build log, then work through the relevant section below. Each entry includes the exact error text, likely cause, and a fix you can apply immediately.
