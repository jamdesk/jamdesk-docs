...
description: This guide explains how Jamdesk builds are triggered, both automatically and manually. Follow the steps here and use the related articles for deeper setup or.
---

This guide explains how Jamdesk builds are triggered, both automatically and manually. Use it to understand what events start a build, how to re-run one, and how branch settings affect deployments. Follow the checks in order to isolate the issue, then use the fixes or contact support if the problem persists.
