...
Most GitHub integration problems come down to repository permissions, webhook delivery failures, or branch mismatches. Check your specific symptom below and follow the steps to restore the connection.
