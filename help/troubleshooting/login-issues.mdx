...
If you cannot log into the Jamdesk dashboard, start with the section that matches your situation: forgotten password, unrecognized email, OAuth errors, or account lockout.
