...
Slack notifications depend on a valid incoming webhook pointed at the right channel. If notifications stop arriving, appear duplicated, or return errors, use the sections below to verify your webhook, fix the issue, or reconnect from scratch.
