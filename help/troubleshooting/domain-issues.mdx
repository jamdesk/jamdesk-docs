---
title: Domain Issues
description: Resolve custom domain and SSL issues with these troubleshooting steps. This guide covers DNS checks, verification delays, and common misconfigurations.
---

Resolve custom domain and SSL issues with these troubleshooting steps. This guide covers DNS checks, verification delays, and common misconfigurations. Follow the checks in order to isolate the issue, then use the fixes or contact support if the problem persists. Screens in the dashboard may vary slightly by plan, but the steps are the same.
