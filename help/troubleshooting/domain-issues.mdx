...
Custom domains require a correctly configured CNAME record and a valid SSL certificate. If your domain is stuck on "Pending," showing certificate errors, or loading the wrong site, work through the matching section below.
