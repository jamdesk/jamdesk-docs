...
3. Check the prop's expected type in the component docs (for example, `cols` expects a number, not a string)
...
3. If a `$ref` points to an external file or URL, confirm the file is included in your project and the URL is reachable
