...
description: Common build errors and how to fix them
---

When a build fails, Jamdesk shows an error code and message in your dashboard. Find your error below for solutions.
