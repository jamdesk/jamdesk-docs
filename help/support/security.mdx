---
title: Security
description: Learn how Jamdesk protects your docs and account data across infrastructure, access, and compliance. Follow the steps here and use the related articles for.
---

Learn how Jamdesk protects your docs and account data across infrastructure, access, and compliance. This page summarizes security practices, data handling, and where to report security concerns. Use it when evaluating vendor risk, answering audits, or explaining Jamdesk security to stakeholders. It also highlights who to contact for security disclosures or incident questions.
