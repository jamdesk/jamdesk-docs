...
description: Search analytics show what readers look for and where content gaps exist. Follow the steps here and use the related articles for deeper setup or.
---

Search analytics show what readers look for and where content gaps exist. This guide helps you access the search dashboard, interpret results, and improve documentation based on real queries. It also points you to related analytics setup and troubleshooting guides so you can dig deeper. Use it as a baseline before you interpret trends or report on performance.
