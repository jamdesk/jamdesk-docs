...
description: Google Tag Manager (GTM) lets you manage analytics, marketing pixels, and other tracking tags without editing code. GTM container IDs start with GTM-.
---

Google Tag Manager (GTM) lets you manage analytics, marketing pixels, and other tracking tags without editing code.

<Info>
GTM container IDs start with `GTM-`. If you just need Google Analytics, see [Google Analytics Integration](/help/google-analytics) for a simpler setup.
</Info>
...
<Columns cols={2}>
  <Card title="Google Analytics" icon="chart-simple" href="/help/google-analytics">
