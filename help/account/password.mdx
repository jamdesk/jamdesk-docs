...
description: Manage your Jamdesk password, including how to change it or reset it if you forget. Follow the steps here and use the related articles for deeper setup or.
---

Manage your Jamdesk password, including how to change it or reset it if you forget. This article walks through the steps and what to expect after the update so you can keep your account secure. Use it when you are managing your account or projects and want to understand the impact before you confirm changes.
