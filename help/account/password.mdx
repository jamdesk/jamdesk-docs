...
<Note>
  This page is about your **Jamdesk account password** (how you sign in to the dashboard). If you're looking to put a password on your published docs site, see [Password Protection](/setup/password-protection), or see [Access Control](/setup/access-control) for an overview of public, password, and SSO options.
</Note>
...
<Columns cols={2}>
  ...
  <Card title="Password Protection" icon="lock" href="/setup/password-protection">
    Put a shared password on your published docs site
  </Card>
  <Card title="Access Control" icon="shield-halved" href="/setup/access-control">
    Compare public, password, and SSO options for your docs
  </Card>
</Columns>
