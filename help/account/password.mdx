...
<Note>
  This page is about your **Jamdesk account password** (how you sign in to the dashboard). If you're looking to put a password on your published docs site, see [Password Protection](/setup/password-protection) — or [Access Control](/setup/access-control) for an overview of public, password, and SSO options.
</Note>
