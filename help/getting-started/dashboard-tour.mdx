...
description: Use this tour to understand the Jamdesk dashboard layout and the key areas you will use daily. Follow the steps here and use the related articles for deeper.
---

Use this tour to understand the Jamdesk dashboard layout and the key areas you will use daily. It points out where to manage projects, builds, analytics, and settings so you can find tasks quickly. Keep it handy when onboarding new team members or when you return after a long break.
