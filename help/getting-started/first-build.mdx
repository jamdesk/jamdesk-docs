...
Your first build starts automatically the moment you connect a repository. The sections below walk through each build phase, how to view the live result, and what to do if something goes wrong.
