...
description: Create your Jamdesk account and choose the sign-up method that matches your team's workflow. Follow the steps here and use the related articles for deeper.
---

Create your Jamdesk account and choose the sign-up method that matches your team's workflow. This guide covers email, Google, and GitHub sign-in options and explains what happens after your account is created. Use it if you are deciding which login method to standardize across your team, and follow the links for onboarding and first builds.
