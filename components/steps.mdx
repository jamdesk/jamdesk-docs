...
|------|------|---------|-------------|
| `titleSize` | `p` \| `h2` \| `h3` | `p` | Heading element for step titles |
...
| `icon` | string | - | Icon name, URL, or path (replaces step number) |
| `iconType` | `solid` \| `regular` \| `light` \| `thin` \| `sharp-solid` \| `duotone` \| `brands` | `solid` | Font Awesome icon style |
| `titleSize` | `p` \| `h2` \| `h3` | inherited | Override the parent Steps titleSize |
| `stepNumber` | number | auto | Manually set step number (auto-assigned if omitted) |
