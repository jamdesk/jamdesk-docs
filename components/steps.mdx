---
title: Steps
description: Use Steps for clear, numbered walkthroughs such as setup and troubleshooting flows. Use the examples to add it to your MDX pages and keep layouts consistent.
---

Use Steps for clear, numbered walkthroughs such as setup and troubleshooting flows. This page shows how to structure steps, add nested content, and keep instructions scannable for readers. You will see example snippets and recommended defaults, plus guidance on when this fits into a Jamdesk documentation workflow. If you are new, start with the basic example and expand from there.
