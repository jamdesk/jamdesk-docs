---
title: Callouts
description: Use Callouts to highlight important context like warnings, tips, or requirements without interrupting the flow. Use the examples to add it to your MDX pages.
---

Use Callouts to highlight important context like warnings, tips, or requirements without interrupting the flow. This guide shows the available callout types, when to use each, and example markup you can copy into your pages. You will see example snippets and recommended defaults, plus guidance on when this fits into a Jamdesk documentation workflow.
