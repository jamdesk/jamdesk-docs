...
title: Callouts
description: >-
  Learn how to use Note, Tip, Warning, Danger, Check, and custom Callout
  components to highlight key information in your docs.
---
...
<AccordionGroup>
  <Accordion title="Use sparingly" icon="hand" defaultOpen>
    ...
    Reserve callouts for information the reader must not miss.
  </Accordion>
