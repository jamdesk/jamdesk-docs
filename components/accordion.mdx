---
title: Accordion
description: Accordions organize content into collapsible sections, letting users expand only what they need. Use the examples to add it to your MDX pages and keep layouts.
---
