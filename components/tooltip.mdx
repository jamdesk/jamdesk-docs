---
title: Tooltip
description: Tooltips display additional context when users hover over text, letting you define terms, explain acronyms, or provide supplementary information without.
---
