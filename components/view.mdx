---
title: View
description: Views let you create documentation that adapts to the reader's framework or language choice. Use the examples to add it to your MDX pages and keep layouts.
---
