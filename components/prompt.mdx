...
Add `claude`, `cursor`, or `chatgpt` to let readers open the prompt in those tools. The first valid open-in action appears beside Copy; additional actions appear in the More menu.
