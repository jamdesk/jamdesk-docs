---
title: Card
description: Use the Card component to highlight content, link to other pages, or group related information into sections.
---
...
<ParamField name="icon" type="string">
  Font Awesome icon name (e.g., "book", "code", "rocket"). Renders in the Solid variant by default; add a style prefix like `light/book` to change the weight. See [Icons](/content/icons).
</ParamField>
