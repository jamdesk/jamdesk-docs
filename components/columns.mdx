---
title: Columns
description: Responsive grid layout for displaying Cards, Tiles, and other content side by side. Automatically adapts to screen size.
---
...
Works with Cards, Tiles, images, and custom components.
