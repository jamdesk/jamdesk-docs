---
title: Columns
description: Columns creates a responsive grid layout for displaying content elements side by side. Use the examples to add it to your MDX pages and keep layouts consistent.
---
