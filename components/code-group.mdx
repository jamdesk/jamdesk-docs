---
title: CodeGroup
description: CodeGroup displays code blocks in a tabbed interface, showing the same operation in multiple languages. Use the examples to add it to your MDX pages and keep.
---
