---
title: Widget
description: Embed a live "What's New" widget demo in your docs with the <Widget> component — a trigger button that opens your changelog in a modal, no script tag needed.
---
...
That renders a button that opens your `/changelog` in a modal. To open a different page, set `page`:
