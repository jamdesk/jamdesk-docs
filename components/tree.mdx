---
title: Tree
description: Tree displays file and folder hierarchies with interactive expand/collapse and full keyboard navigation. Use the examples to add it to your MDX pages and keep.
---
