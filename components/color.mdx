...
Color displays hex, RGB, and RGBA values as click-to-copy swatches. It has two layout variants, a compact grid and a grouped table, with built-in light and dark mode support.
