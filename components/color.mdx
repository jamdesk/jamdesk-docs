---
title: Color
description: Display color palettes with swatches, labels, and click-to-copy functionality for design system documentation
---

The Color component displays color palettes for documenting design systems, brand guidelines, or any color specification. Each swatch shows the color with its name and value, and clicking copies the value to the clipboard—making it easy for developers to grab the exact colors they need.
