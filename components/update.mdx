---
title: Update
description: The Update component creates timeline-style changelog entries that automatically integrate with your Table of Contents. Use the examples to add it to your MDX.
---
