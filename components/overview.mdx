...
<CardGroup cols={3}>
  <Card title="Card" icon="square" href="/docs/components/card">
  ...
  <Card title="Accordion" icon="chevron-down" href="/docs/components/accordion">
    Collapsible content sections
  </Card>
  <Card title="Steps" icon="list-ol" href="/docs/components/steps">
    Numbered step-by-step guides
  </Card>
  <Card title="Expandable" icon="expand" href="/docs/components/expandable">
    Show/hide additional content
  </Card>
  <Card title="Frame" icon="image" href="/docs/components/frame">
...
<CardGroup cols={3}>
  <Card title="CodeGroup" icon="layer-group" href="/docs/components/code-group">
