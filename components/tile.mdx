...
When a screenshot or logo communicates more than text, use Tile instead of Card. Each tile renders an image-first preview with a patterned background, optional title, and optional description -- well suited for integration pages, template galleries, and visual showcases.
