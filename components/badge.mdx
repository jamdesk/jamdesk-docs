---
title: Badge
description: Badges are small, inline labels used to highlight status, categories, or other metadata. They work well both standalone and inline within text.
---
