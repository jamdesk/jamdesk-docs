...
|------|------|---------|-------------|
| `color` | string | gray | Color variant: `gray`, `blue`, `green`, `yellow`, `orange`, `red`, `purple`, `white`, `surface`, `white-destructive`, `surface-destructive` |
| `size` | string | md | Badge size: `xs`, `sm`, `md`, `lg` |
| `shape` | string | rounded | Badge shape: `rounded`, `pill` |
| `icon` | string | - | Font Awesome icon name |
| `iconType` | string | - | Icon style: `regular`, `solid`, `light`, `thin`, `sharp-solid`, `duotone`, `brands` |
| `stroke` | boolean | false | Display as outlined badge with transparent background |
| `disabled` | boolean | false | Reduce opacity to indicate inactive state |
