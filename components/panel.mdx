---
title: Panel
description: Panel lets you display custom content in the right sidebar instead of the default Table of Contents. Use the examples to add it to your MDX pages and keep.
---
