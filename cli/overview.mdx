...
<Accordion title="jamdesk deploy-proxy cloudflare" icon="cloud">
  ...
  Interactive by default: it checks Wrangler, verifies your Cloudflare account, auto-detects your slug from `docs.json`, generates the Worker files, and optionally deploys.
