---
title: CLI Overview
description: The Jamdesk CLI is the fastest way to preview, validate, and maintain your docs from the terminal. Use it to understand the workflow and decide the next steps.
---

The Jamdesk CLI is the fastest way to preview, validate, and maintain your docs from the terminal. This overview explains the core commands, when to use each, and where to go for deeper guides on local development, validation, and troubleshooting. You will see example snippets and recommended defaults, plus guidance on when this fits into a Jamdesk documentation workflow.
