...
Usalo per una scheda che non andrebbe copiata così com'è, ad esempio un esempio cURL con un token segnaposto, lasciando copiabili gli esempi funzionanti nelle altre schede. Per lo stesso flag su un blocco singolo consulta [Blocchi di codice → Nascondere il pulsante di copia](/it/content/code-blocks#nascondere-il-pulsante-di-copia).
