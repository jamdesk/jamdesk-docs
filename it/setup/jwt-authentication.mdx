...
Apri solo i percorsi che le tue pagine pubbliche usano davvero. Un glob ampio come `/**` apre tutte le risorse del sito, comprese le schermate contenute nelle pagine che volevi riservare ai visitatori autenticati.
