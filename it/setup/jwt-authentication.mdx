...
| `expiresAt` | No | Timestamp Unix (in secondi) che indica la durata della *sessione* risultante. Il limite è 30 giorni; se omesso, il valore predefinito è 7 giorni. È indipendente dal claim `exp` a breve durata del token. |
