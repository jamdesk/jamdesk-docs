...
<Update label="May 2026" date="2026-05-05">
**Showcase Page opt-in.** A new **Feature on Showcase Page** toggle in **Settings → Display Settings** controls whether your project appears in the upcoming Jamdesk customer showcase. Existing projects are opted in by default; flip the toggle off any time to opt out. The showcase page itself is still in the works — we'll link it from here when it ships.
</Update>
