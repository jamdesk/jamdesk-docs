...
**A fourth theme: Halo.** Set `"theme": "halo"` in your `docs.json` for a warm, softly rounded look — a sand background with your content raised on a card, a caramel accent, and Figtree throughout. It's the cozy end of the family, built for docs people read start to finish. [Theming →](/customization/theming)
