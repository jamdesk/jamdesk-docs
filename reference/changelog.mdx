...
**Grouped search results.** The site search modal now buckets hits under their parent page instead of listing every section match separately. Up to three sections show by default with an inline expander for the rest, and snippet highlighting is preserved. Readers stop seeing the same page repeated five times and find the right section in fewer scans.
