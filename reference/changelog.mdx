...
**Edit your docs right in the dashboard.** The web editor is now available to everyone — no setup required. Open **Editor** in the sidebar to browse your connected repo, edit MDX with a live preview, and commit straight to your GitHub branch, which kicks off a build automatically. Every project owner and team member gets it, on every plan.
