...
description: Create AI-ready documentation from MDX and GitHub. Deploy in seconds with built-in search, analytics, and themes.
---
...
<Columns cols={2}>
  <Card title="AI-Ready (llms.txt)" icon="robot" href="/development/ai-documentation">
    Auto-generated `llms.txt` for ChatGPT, Claude, and Copilot to index your docs.
  </Card>
  <Card title="MCP Integration" icon="plug-circle-bolt" href="/development/mcp-integration">
