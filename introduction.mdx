...
<Columns cols={2}>
  ...
  <Card title="Themes & Branding" icon="paintbrush" href="/customization/theming">
    Pick from Jam, Nebula, or Pulsar, then override colors, fonts, and styles to match your brand.
  </Card>
...
<Tip>
**Need private docs?** Lock your whole site behind a password, gate individual pages with `private: true`, or use SSO on Enterprise. See [Access Control](/setup/access-control).
</Tip>
