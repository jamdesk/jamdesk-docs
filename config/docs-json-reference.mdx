...
Opt in to shared-password protection for your site. Declarative config only — you still set the actual passphrase in the [dashboard](/setup/password-protection#rotating-the-password) after the next build runs.
