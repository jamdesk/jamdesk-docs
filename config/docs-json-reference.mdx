...
Show a site-wide announcement bar pinned to the top of every page — above the header, full width, in your theme's accent color. Use it for launches, migrations, maintenance windows, or any message every visitor should see.
