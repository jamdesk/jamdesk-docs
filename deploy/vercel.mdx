...
<Note>
Using a custom subpath instead of the default `/docs`? Replace every `/docs` in the snippets below with your configured subpath — in both the `source` and `destination` of each rule — and redeploy after any rename in the dashboard; nothing regenerates this file for you.
</Note>
