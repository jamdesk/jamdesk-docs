...
<Steps>
  ...
  <Step title="Flip the toggle">
    Open your project in the dashboard, expand **Custom domain setup**, and turn on **Custom domain only**. Jamdesk checks your live domain first and won't enable the toggle until your setup passes — if the check fails, the message tells you exactly what to fix.
  </Step>
</Steps>
