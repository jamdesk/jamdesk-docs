...
<Note>
Using a custom subpath instead of the default `/docs`? Replace `/docs` in every location/route block below (nginx, Apache, Caddy, Traefik, HAProxy) with your configured subpath, and update your configuration again after any rename in the dashboard.
</Note>
