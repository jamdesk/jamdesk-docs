---
title: Reverse Proxy
description: Serve docs at /docs using nginx, Apache, Caddy, Traefik, or HAProxy.
---
...
<VirtualHost *:443>
    ...
    # AI chat endpoint
    ProxyPass /_chat https://YOUR_SLUG.jamdesk.app/_chat
    ProxyPassReverse /_chat https://YOUR_SLUG.jamdesk.app/_chat
...
http:
  routers:
    docs-router:
      rule: "Host(`yoursite.com`) && (PathPrefix(`/docs`) || PathPrefix(`/_next`) || PathPrefix(`/_jd`) || PathPrefix(`/_chat`))"
...
frontend https
    ...
    acl is_chat path_beg /_chat
    use_backend jamdesk_docs if is_docs or is_next or is_jd or is_chat
