...
<Warning>
The `X-Jamdesk-Forwarded-Host` header is required for domain verification. Your domain must be verified in the Jamdesk dashboard before the proxy will serve content.
</Warning>
