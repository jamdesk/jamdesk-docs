---
title: Reverse Proxy
description: Use a reverse proxy to serve your Jamdesk documentation at a /docs subpath. This guide covers nginx, Apache, and general proxy configuration.
---

If you already run nginx, Apache, Caddy, Traefik, or HAProxy in front of your site, you can add a location/route block that forwards `/docs` traffic to your Jamdesk subdomain. Configuration examples for each server are provided below.
