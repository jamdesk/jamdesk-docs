...
description: How Jamdesk builds and deploys your docs from git push to live site. Covers build triggers, status monitoring, rollbacks, and environment variables.
---
...
See [Builds API / Triggers](/reference/builds-api) for authentication, error handling, and rate limits.
