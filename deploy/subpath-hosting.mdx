...
By default, your docs are served at `/docs`. To use something else, like `/help` or `/support`, enter it in the subpath field next to the toggle. The toggle label updates live to show the path you're about to enable (`Host at /help`, and so on).
