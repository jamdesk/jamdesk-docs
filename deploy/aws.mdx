...
<Note>
If you use a custom subpath instead of the default `/docs`, replace `/docs/*` in the cache behavior path pattern (Step 3) with your subpath. Update the distribution again after any rename in the dashboard.
</Note>
