...
description: Use Amazon CloudFront as a CDN to proxy documentation requests to Jamdesk. This guide covers setting up CloudFront with Route 53 for DNS.
---

By the end of this walkthrough you will have a CloudFront distribution forwarding `/docs/*` traffic to your Jamdesk site, with Route 53 handling DNS. You need an AWS account, your Jamdesk subdomain, and about 15 minutes.
