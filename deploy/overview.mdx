...
Host docs at a subpath on your domain — `example.com/docs` by default, or a custom segment like `example.com/help` — by proxying traffic to Jamdesk. This is ideal when you want docs to live under your main marketing domain.
