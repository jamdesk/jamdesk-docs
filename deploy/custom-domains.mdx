...
description: Connect your own domain to serve documentation at docs.yourdomain.com. Covers DNS configuration, SSL certificates, and verification.
---

Serve your documentation from your own domain instead of the default `*.jamdesk.app` subdomain. Custom domains provide branded URLs and integrate with your existing web presence.
