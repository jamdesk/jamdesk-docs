...
| `lastUpdatedDate` | string | - | Überschreibt das „Last updated on“-Datum dieser Seite, statt das Datum ihres letzten Git-Commits zu verwenden. Setzen Sie den Wert in Anführungszeichen: `"2026-09-01"`. Die Fußzeile benötigt `metadata.timestamp` in `docs.json`; Ihre Sitemap und Ihre strukturierten Daten verwenden das Datum ohnehin. Siehe [Datum der letzten Aktualisierung](#datum-der-letzten-aktualisierung) |
