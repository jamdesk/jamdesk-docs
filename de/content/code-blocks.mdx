...
## Kopier-Schaltfläche ausblenden

Füge `nocopy` hinzu, um bei einem einzelnen Block die Kopier-Schaltfläche zu entfernen:
...
Nutze es überall dort, wo Kopieren dem Leser etwas geben würde, das nicht funktioniert: ein Terminal-Mitschnitt mit vermischten Eingabeaufforderungen und Ausgaben, ein geschwärztes Beispiel oder ein „So bitte nicht“-Snippet.

`nocopy` lässt sich mit allen anderen Optionen kombinieren:
