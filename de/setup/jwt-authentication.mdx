...
| `expiresAt` | Nein | Unix-Zeitstempel (Sekunden), der angibt, wie lange die resultierende *Sitzung* gültig sein soll. Begrenzt auf 30 Tage; ohne Angabe gilt ein Standardwert von 7 Tagen. Dies ist unabhängig vom eigenen kurzlebigen `exp`-Claim des Tokens. |
