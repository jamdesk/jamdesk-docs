...
Nutze es für einen Tab, der nicht unverändert kopiert werden sollte, etwa ein cURL-Beispiel mit einem Platzhalter-Token, und lasse die funktionierenden Beispiele in den anderen Tabs kopierbar. Zum Flag auf einem einzelnen Block siehe [Code-Blöcke → Kopier-Schaltfläche ausblenden](/de/content/code-blocks#kopier-schaltfläche-ausblenden).
