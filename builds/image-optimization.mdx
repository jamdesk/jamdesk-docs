...
Unused images get a pass too. If a file sits in your `/images` directory but nothing in your MDX or config references it, the original uploads as-is. No wasted CPU on files nobody loads.
...
When the feature is on, your build shows an **Optimizing images** step in the dashboard progress list, between "Building documentation" and "Uploading to CDN".
