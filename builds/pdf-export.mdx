...
<Accordion title="Regenerate didn't produce a new file">
  The cached PDF was reused because your last completed build's commit hasn't changed. You need a new build to force a fresh render. See [Caching and Regenerate](#caching-and-regenerate).
</Accordion>
