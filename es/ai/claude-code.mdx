...
<Steps>
  ...
  <Step title="Conecta tu documentación mediante MCP">
    ...
    Reemplaza `your-project` por tu subdominio de Jamdesk — o, si tienes un dominio personalizado activo, úsalo en su lugar: `https://docs.acme.com/_mcp`. Claude puede ahora buscar y leer tu documentación publicada directamente. Consulta [MCP Server](/es/ai/mcp-server) para más detalles.
  </Step>
