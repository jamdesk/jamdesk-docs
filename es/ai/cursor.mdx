---
title: Cursor
description: "Configura Cursor para escribir documentación de Jamdesk en MDX, con autocompletado de componentes y acceso al servidor MCP para contexto en vivo."
---

[Cursor](https://cursor.com) es un editor de código con IA basado en VS Code. Su edición en línea (Cmd+K) y su chat (Cmd+L) funcionan bien para escribir MDX de forma iterativa: selecciona un párrafo, describe lo que quieres y Cursor lo reescribe ahí mismo.

## Configuración rápida

<Steps>
  <Step title="Abre tu proyecto de documentación">
    Abre el directorio de documentación de Jamdesk en Cursor.
  </Step>
  ...
  <Step title="Conecta el servidor MCP">
    Añade el endpoint MCP de tu documentación a `.cursor/mcp.json` para que Cursor pueda buscar en tu documentación publicada.
  </Step>
</Steps>
...
Reemplaza `your-project` por tu subdominio de Jamdesk; o, si ya tienes un dominio personalizado activo, úsalo en su lugar: `"url": "https://docs.acme.com/_mcp"`. Consulta [Servidor MCP](/es/ai/mcp-server) para más información sobre el endpoint.

## Flujos de trabajo

<Tabs>
  <Tab title="Edición en línea (Cmd+K)">
    Selecciona texto en un archivo MDX y pulsa **Cmd+K** para describir lo que quieres cambiar. Funciona bien para:
  ...
  <Tab title="Chat (Cmd+L)">
    ...
    - "Escribe una sección de solución de problemas para [feature]"
    - "Revisa esta página según nuestros estándares de redacción"
  </Tab>
  <Tab title="Composer">
    Usa Composer para tareas de documentación que afectan a varios archivos:
    - Generar una nueva sección con varias páginas
    - Reestructurar la navegación entre archivos
    - Actualizar en bloque los patrones de uso de componentes
  </Tab>
</Tabs>

## La skill /update-jamdesk

Para actualizaciones automatizadas de la documentación cuando cambie el código, instala la skill `/update-jamdesk`:
