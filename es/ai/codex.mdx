...
Reemplaza `your-project` con tu subdominio de Jamdesk. Consulta [MCP Server](/es/ai/mcp-server) para conocer los detalles del endpoint y la configuración de dominio personalizado.
