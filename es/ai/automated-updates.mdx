...
description: Mantén la documentación sincronizada con tu código usando el skill /update-jamdesk para Claude Code. Actualiza automáticamente los docs cuando implementas funcionalidades.
---
