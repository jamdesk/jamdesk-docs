...
<Tip>
  ¿Prefieres quedarte en el dashboard? [Fix with AI](/es/builds/fix-with-ai) hace la misma corrección sobre un build, también cubre las descripciones de página faltantes y confirma los cambios en GitHub por ti.
</Tip>
...
<Columns cols={2}>
  <Card title="Fix with AI" icon="wand-magic-sparkles" href="/es/builds/fix-with-ai">
    Corrige problemas desde el dashboard y confirma en GitHub
  </Card>
