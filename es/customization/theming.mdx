...
Reemplaza las fuentes del tema con [CSS personalizado](/es/customization/custom-css#fuentes-externas). Carga cualquier Google Font o fuente autoalojada y reasigna las variables CSS `--font-family-sans` y `--font-family-mono`.
...
<Tip>
**¿Necesitas más que colores?** [CSS personalizado](/es/customization/custom-css) te permite reemplazar fuentes, espaciado, ancho del contenido, radios de borde, estilos de llamadas y detalles a nivel de componente. Los temas establecen los valores predeterminados; CSS personalizado es la vía de escape para todo lo que CSS pueda tocar.
</Tip>
