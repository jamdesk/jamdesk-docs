...
- En el preview local (`jamdesk dev`), las ediciones a `style.css` se aplican al actualizar el navegador; en tu sitio publicado, los cambios toman efecto en el próximo build
