...
description: Agrega CSS personalizado para sobrescribir estilos del tema, ajustar tipografía o añadir estilos de marca. Jamdesk expone variables CSS para personalizaciones comunes.
---
...
- Algunos estilos de diseño internos usan `!important` y pueden requerir lo mismo para sobreescribirlos
- En el preview local (`jamdesk dev`), las ediciones a tus archivos CSS se aplican al actualizar el navegador; en tu sitio publicado, los cambios toman efecto en el próximo build
...
<Columns cols={2}>
  ...
  <Card title="Branding" icon="image" href="/es/customization/branding">
    Logos, colores e identidad de marca
  </Card>
</Columns>
