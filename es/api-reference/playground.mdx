...
<Steps>
  ...
  <Step title="Envía la solicitud">
    En modo interactivo, haz clic en Enviar (o presiona `Ctrl/Cmd+Enter`) para ejecutar la solicitud. La respuesta se muestra debajo con código de estado, duración y cuerpo formateado.
  </Step>
</Steps>
