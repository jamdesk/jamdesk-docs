...
Jamdesk clona tu repositorio, valida `docs.json` y la sintaxis MDX, compila a HTML optimizado con indexación de búsqueda y luego procede a desplegar el sitio en Cloudflare R2. La mayoría de los sitios se compilan en 30-90 segundos.
...
La versión anterior vuelve a estar en vivo de inmediato, mientras Jamdesk empieza a desplegar el nuevo build.
