...
description: Aloja tu documentación en yoursite.com/docs en lugar de un subdominio separado. Incluye configuraciones para Vercel, CloudFront, Cloudflare y reverse proxy.
---
