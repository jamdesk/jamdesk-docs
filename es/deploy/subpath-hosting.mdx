...
<Note>
Activar o desactivar "Host at a subpath" desencadena una reconstrucción automática de tu documentación. Esto es necesario porque la estructura de URL cambia entre `/introduction` y `/docs/introduction`.
</Note>
