---
title: Vercel
description: "Descubre dos formas de servir tu documentación de Jamdesk en /docs en tu dominio desplegado en Vercel: reescrituras de vercel.json o Edge Middleware."
---
...
- Tu subdominio de Jamdesk (que se encuentra en la configuración del dashboard), con **Host at a subpath** habilitado
