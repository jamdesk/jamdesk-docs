...
Agrega `nocopy` para quitar el botón de copiar de un solo bloque:
...
Úsalo siempre que copiar el bloque le dé al lector algo que no funciona: una transcripción de terminal con los prompts y la salida mezclados, un ejemplo censurado o un fragmento de "no hagas esto".
