...
Jamdesk genera automáticamente una tarjeta social de 1200×630 píxeles con tu marca para cada página. Puedes sobrescribir cualquier etiqueta social en el frontmatter. Puedes usar **claves planas de nivel superior** o un bloque **`seo:`** anidado. Ambas opciones funcionan; cuando la misma clave se define de las dos formas, el valor plano de nivel superior tiene prioridad.
