...
<Card title="Vista previa OpenGraph" icon="share-nodes" href="https://jamdesk.com/utilities/opengraph-preview" horizontal>
...
- **Imagen social** — Establece un `og:image` personalizado en las páginas clave, o usa la tarjeta generada automáticamente. Verifícala con la herramienta [OpenGraph Preview](https://jamdesk.com/utilities/opengraph-preview).
</Note>
