...
description: Controla títulos, descripciones y metaetiquetas para buscadores y previsualizaciones sociales. Jamdesk genera sitemaps e imágenes Open Graph automáticamente.
---
...
| Valor | Aspecto |
|-------|---------|
| `summary` | Miniatura cuadrada pequeña a la izquierda, título + descripción al lado. Compacto. |
| `summary_large_image` | Imagen grande a todo ancho arriba, título + descripción abajo. La opción llamativa. |
...
- **Texto alternativo en imágenes** — Cada imagen tiene texto alt para accesibilidad y búsqueda de imágenes.
- **Imagen social** — Define un `og:image` personalizado en páginas clave o confía en la tarjeta generada automáticamente.
</Note>
