...
description: Enlaza entre páginas, crea anclas a encabezados específicos y referencia URLs externas. Incluye navegación con Card y verificación de enlaces rotos.
sidebarTitle: Enlaces y navegación
---
...
<AccordionGroup>
  ...
  <Accordion title="Enlaza al nivel correcto" icon="sitemap">
    Enlaza a la sección específica más relevante:
  ...
  <Accordion title="Mantén los enlaces al día" icon="rotate">
    ...
    Esto analiza tu documentación y reporta cualquier enlace interno roto.
  </Accordion>
</AccordionGroup>
...
- Renombra el archivo
- Actualiza la navegación en `docs.json`
...
<Columns cols={2}>
  <Card title="Optimización SEO" icon="magnifying-glass-chart" href="/es/content/seo">
    Mejora la discoverabilidad y los metadatos
  </Card>
