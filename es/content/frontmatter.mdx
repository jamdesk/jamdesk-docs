...
description: Configure títulos de página, descripciones, iconos, anulaciones de barra lateral y metadatos SEO con el bloque YAML frontmatter en la parte superior de cada archivo MDX.
---
