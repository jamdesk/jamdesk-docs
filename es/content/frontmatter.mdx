...
<Tip>
Después de un build, pega la URL de la página en la herramienta gratuita [OpenGraph Preview](https://www.jamdesk.com/utilities/opengraph-preview) para ver cómo se renderizan estas etiquetas en X, Facebook, LinkedIn, Slack, Discord y más.
</Tip>
