...
Abre solo las rutas que tus páginas públicas usan de verdad. Un glob amplio como `/**` abre todos los recursos del sitio, incluidas las capturas de pantalla de las páginas que querías reservar a visitantes con sesión iniciada.
