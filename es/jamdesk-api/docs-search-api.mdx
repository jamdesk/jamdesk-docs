...
<Info>
Un proyecto es multilingüe cuando su `docs.json` tiene un arreglo `navigation.languages` con dos o más entradas. Para comprobarlo, abra la pestaña **Settings → Languages** del dashboard, o revise `docs.json` directamente.
</Info>
