...
| `data-page` | Ruta | `/changelog` | Cualquier ruta de tu documentación para abrir en la modal, no solo el changelog. Consulta [Abrir cualquier página](#abrir-cualquier-pagina). |
