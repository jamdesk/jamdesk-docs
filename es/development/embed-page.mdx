...
| `data-page` | Ruta | `/changelog` | Cualquier ruta de documentación para abrir en el modal, no solo el changelog. Consulta [Apuntar el modal a cualquier página](#apuntar-el-modal-a-cualquier-página). |
