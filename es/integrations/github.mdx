...
Cuando configuras un proyecto, Jamdesk te guía para conectar GitHub. Hay dos opciones.
...
¿Ya tienes un repositorio de documentación? Instala la Jamdesk GitHub App, concédele acceso a ese repositorio y luego elige el repositorio y la rama en Jamdesk en **Configuración del proyecto → Repositorio Git**. A partir de ahí, funciona de la misma manera.
...
Si la ventana emergente de GitHub no se abre, es posible que tu navegador la haya bloqueado. Busca el icono del bloqueador de ventanas emergentes en tu barra de direcciones, permite las ventanas emergentes de Jamdesk y luego haz clic en **Intentar de nuevo**.
