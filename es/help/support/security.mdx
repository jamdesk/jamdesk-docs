...
Nunca hacemos push, creamos ramas ni modificamos tu repositorio. Puedes revocar el acceso de Jamdesk en cualquier momento desde la [configuración de aplicaciones de GitHub](https://github.com/settings/installations).
