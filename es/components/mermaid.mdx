...
description: Renderiza diagramas de flujo, diagramas de secuencia, líneas de tiempo, gráficos circulares y más desde sintaxis Mermaid basada en texto. Los diagramas se construyen como SVG en tiempo de compilación.
---

Escribe diagramas como texto en bloques de código delimitados. Jamdesk los renderiza como SVG en tiempo de compilación.
