...
description: Añade un formulario de suscripción a newsletter o changelog en cualquier página de documentación con el componente EmailSubscribe: captura nativa para siete proveedores, embeds para el resto.
---
