...
<Card title="Guía rápida" icon="star" href="/es/quickstart" cta="Upgrade now">
...
<Card title="Guía rápida" icon="rocket" href="/es/quickstart" arrow={true} cta="Start building">
