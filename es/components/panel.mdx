...
description: >-
  ...
  referencias rápidas, en la barra lateral mientras los lectores se
  desplazan.
---

Panel te permite mostrar contenido personalizado en la barra lateral derecha en lugar de la Tabla de contenidos predeterminada. El contenido permanece visible mientras los lectores se desplazan por tu página, lo que lo hace ideal para información que siempre debe estar accesible—como referencias rápidas, advertencias importantes o enlaces de soporte.

Usa Panel cuando:
- La **información crítica** no debe desaparecer al hacer scroll
...
Panel funciona bien para advertencias fijadas, tarjetas de referencia rápida y enlaces de soporte:
...
- **Documentación estándar** - La mayoría de las páginas funcionan mejor con la Tabla de contenidos predeterminada
