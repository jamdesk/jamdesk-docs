...
## Ocultar el botón de copiar en una pestaña

Agrega `nocopy` a un bloque para quitar el botón de copiar solo en esa pestaña; las demás pestañas del grupo conservan el suyo:
...
Úsalo para una pestaña que no debería copiarse tal cual, como un ejemplo de cURL con un token de marcador de posición, y deja copiables los ejemplos que sí funcionan en las otras pestañas. Consulta [Bloques de código → Ocultar el botón de copiar](/es/content/code-blocks#ocultar-el-botón-de-copiar) para la marca en un bloque independiente.
