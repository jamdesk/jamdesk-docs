...
Que tu documentación sea encontrada depende en parte de lo rápido que cargue. Google usa [Core Web Vitals](https://jamdesk.com/blog/why-google-pagespeed-matters) como señal de clasificación, y los rastreadores de IA como GPTBot y ClaudeBot se dan 1–5 segundos por página. Si tu documentación no carga en ese tiempo, no será citada.
