...
Every Jamdesk documentation site includes a built-in MCP (Model Context Protocol) server. AI coding assistants can search your docs and retrieve page content directly, giving them accurate context about your project.
