...
The app talks directly to the same Firebase backend as the web dashboard — no separate API layer, no analytics relay. Your project data never leaves Jamdesk infrastructure.
