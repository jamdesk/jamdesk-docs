...
description: Start, stop, and restart the Jamdesk dev server from the VS Code status bar with one-click controls and auto browser preview.
---

Preview your documentation without leaving VS Code. The Jamdesk extension adds a status bar button that starts `jamdesk dev`, monitors the server, and opens your browser when it's ready — no terminal required.
