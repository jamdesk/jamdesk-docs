...
<CardGroup cols={2}>
  <Card title="Custom Domains" icon="globe" href="/customization/branding">
    Brand your docs with custom domains and logos
  </Card>
  <Card title="Analytics" icon="chart-line" href="/config/docs-json-reference">
