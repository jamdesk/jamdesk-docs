...
description: Keep your documentation in sync with your code using the /update-jamdesk skill for Claude Code. Use it to standardize workflows across your team and speed up.
---
