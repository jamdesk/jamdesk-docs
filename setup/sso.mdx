...
<Tip>
  Want per-user docs access without an Enterprise plan? If your product has its own login, [JWT authentication](/setup/jwt-authentication) lets your backend sign readers in, on every plan.
</Tip>
