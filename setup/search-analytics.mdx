...
<Warning>
Content gaps are searches that returned zero results. Each one is a topic your docs do not cover yet.
</Warning>
...
Review content gaps regularly. The Best Practices section below suggests a weekly cadence.
