...
description: Jamdesk includes built-in analytics to help you understand how visitors use your documentation. Follow it when configuring new projects or onboarding.
---
...
<Note>
If metrics look empty or delayed, see [Analytics Issues](/help/troubleshooting/analytics-issues).
</Note>
