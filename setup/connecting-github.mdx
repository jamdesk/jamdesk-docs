...
description: Jamdesk integrates with GitHub to automatically deploy your documentation when you push changes. New to GitHub integration?
---

Jamdesk integrates with GitHub to automatically deploy your documentation when you push changes.

<Info>
**New to GitHub integration?** Read [Understanding GitHub Integration](/help/github-integration) to learn how the GitHub App and personal account linking work together.
</Info>
...
This is separate from the GitHub App and ensures your commits are properly attributed to you. [Learn more](/help/github-integration#personal-github-account-user-level).
...
<Note>
  For more detailed troubleshooting, see [Understanding GitHub Integration](/help/github-integration).
</Note>
