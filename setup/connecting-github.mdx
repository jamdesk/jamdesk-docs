...
description: Connect your GitHub repository to enable automatic deployments when you push changes.
---

Jamdesk integrates with GitHub to automatically deploy your documentation when you push changes.

<Note>
For background on how the GitHub App and personal account linking work together, see [Understanding GitHub Integration](/help/github-integration).
</Note>
