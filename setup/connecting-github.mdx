...
<Tip>
Docs in Bitbucket Cloud instead? See [Connect Bitbucket](/setup/connecting-bitbucket). Each project connects to one provider.
</Tip>
...
### GitHub keeps sending you back to the Jamdesk app page
