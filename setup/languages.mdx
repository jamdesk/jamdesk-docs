...
|----------|-------|--------------|
| English (default) | `docs.example.com/llms.txt` | `docs.example.com/en/llms-full.txt` |
...
The root `docs.example.com/llms-full.txt` still contains every language. A language gets its own files once it has at least one page. [Multilingual sites →](/ai/llms-txt#multilingual-sites)
