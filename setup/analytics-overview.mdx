...
description: Jamdesk includes two analytics dashboards: Project Analytics for traffic and engagement, and Search Analytics for on-site search behavior.
---

Jamdesk includes two analytics dashboards: **Project Analytics** for traffic and engagement, and **Search Analytics** for on-site search behavior.
