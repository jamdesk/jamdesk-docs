...
description: Create and configure your documentation project in the Jamdesk dashboard
---
...
<Steps>
  <Step title="Sign in to Jamdesk">
    Go to [app.jamdesk.com](https://app.jamdesk.com) and sign in with your GitHub account.
