...
<Tip>
  **Check your score.** See how agent-ready any docs site is with the free [AI Score](https://www.jamdesk.com/ai-score) tool — publishing a valid `llms.txt` is one of the first things it checks for.
</Tip>
