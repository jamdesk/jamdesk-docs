...
<Tip>
  **See how your docs score.** Jamdesk scores your own docs on every build. Open [AI Score](/ai/ai-score) in the dashboard for your grade and the issues to fix. You can also run any documentation site through the free [AI Score tool](https://jamdesk.com/ai-score), graded on the open [AFDocs](https://afdocs.dev) standard, or grade sites as you browse with the [AI Score Chrome extension](https://chromewebstore.google.com/detail/jamdesk-ai-score/mhihkkgpcbmapmojnakhjfhjmiagkhlj).
</Tip>
...
<Columns cols={2}>
  ...
  <Card title="AI Chat" icon="comment" href="/ai/chat">
    Built-in chat assistant: visitors ask questions and get citation-backed answers
  </Card>
...
<Columns cols={2}>
  ...
  <Card title="Automated Updates" icon="rotate" href="/ai/automated-updates">
    The `/update-jamdesk` skill auto-generates docs from code changes
  </Card>
</Columns>
