...
<Tabs>
  ...
  <Tab title="Quick reference">
    Returning users ask things like *"What parameters does the /users endpoint accept?"* and chat pulls the endpoint docs and returns the parameter table directly.
  </Tab>
</Tabs>
