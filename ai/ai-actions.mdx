...
<img src="/images/ai-actions.webp" alt="AI Actions dropdown showing Copy page, View as Markdown, Open in ChatGPT, Open in Claude, Open in Perplexity, Copy MCP config, Add to Cursor, and Add to VS Code options" style={{ maxWidth: '600px' }} />
