...
<Steps>
  ...
  <Step title="Connect your docs via MCP">
    ...
    Replace `your-project` with your Jamdesk subdomain — or, if you have a custom domain live, use it instead: `https://docs.acme.com/_mcp`. Claude can now search and read your published docs directly. See [MCP Server](/ai/mcp-server) for details.
  </Step>
