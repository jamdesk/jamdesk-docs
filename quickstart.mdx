...
<Tip>
**Want to keep some pages private?** Add `private: true` to any MDX file's frontmatter and it gates behind a password after the next build. See [Access Control](/setup/access-control) for all four options (public, whole-site password, mixed, SSO).
</Tip>
