---
title: Thèmes
description: Choisissez parmi Jam, Nebula ou Pulsar pour contrôler typographie, mise en page et mode sombre. Adaptez les couleurs à votre marque.
---
...
Pour tester le mode sombre pendant le développement, utilisez le bouton bascule de la barre de navigation ou émulez-le dans les DevTools :
