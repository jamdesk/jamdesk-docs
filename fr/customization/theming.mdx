---
title: Thèmes
description: Choisissez un thème intégré (Jam, Nebula, Pulsar ou Halo) pour gérer typographie, mise en page, espacement et mode sombre. Personnalisez les couleurs.
---
...
<Tabs>
  ...
  <Tab title="Halo" icon="sun">
    ...
    Mise en page avec logo dans l'en-tête et Figtree partout. Fond sable chaud (`#F7F2E8`) avec le contenu surélevé sur une carte. Fortement arrondi (8-28px).
