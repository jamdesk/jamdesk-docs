...
- En preview locale (`jamdesk dev`), les modifications de `style.css` s'appliquent au rechargement du navigateur ; sur votre site publié, les changements prennent effet au prochain build
