...
description: Ajoutez du CSS personnalisé pour remplacer les styles du thème, ajuster la typographie ou ajouter un style spécifique à votre marque. Jamdesk expose des variables CSS pour les personnalisations courantes.
---
