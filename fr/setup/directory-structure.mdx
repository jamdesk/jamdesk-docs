...
Jamdesk sert automatiquement la spécification correcte lorsqu'une page est rendue sous un préfixe de langue (`/fr/…`, `/es/…`, etc.). Consultez [Support multilingue → Traduction des spécifications OpenAPI](/fr/setup/languages#translating-openapi-specs) pour les règles complètes sur ce qu'il faut traduire et ce qu'il faut conserver à l'identique.
