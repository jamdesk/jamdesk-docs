---
title: Redirections
description: "Configurez des redirections URL pour pages déplacées, routes renommées et URL héritées. Prend en charge les correspondances exactes et les patterns de routes."
---
