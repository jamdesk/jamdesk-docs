---
title: Redirections
description: Configurez des redirections URL pour les pages déplacées, les routes renommées et les URL héritées. Prend en charge les correspondances exactes et les redirections basées sur des patterns.
---
