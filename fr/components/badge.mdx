...
description: Étiquettes inline pour le statut, les catégories et les métadonnées -- 11 variantes de couleurs, 4 tailles, icônes, formes pilule/arrondies et contours en trait.
---
