---
title: Exemples
description: Épinglez des blocs de code dans une barre latérale droite persistante sur desktop afin que les lecteurs puissent les consulter en faisant défiler la page. Prend en charge plusieurs langages avec des onglets.
---
