---
title: Champs
description: Documentez les paramètres API et les champs de réponse avec les composants ParamField et ResponseField. Prend en charge les types, les valeurs par défaut et les objets imbriqués.
---
