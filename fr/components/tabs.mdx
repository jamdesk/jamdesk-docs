---
title: Onglets
description: Panneaux pour du contenu mutuellement exclusif (gestionnaires de paquets, langages). Les titres correspondants se synchronisent sur toute la page.
---
...
<Tabs borderBottom>
  ...
  <Tab title="Details">
    Utile quand les onglets contiennent des longueurs de contenu variables.
  </Tab>
</Tabs>
