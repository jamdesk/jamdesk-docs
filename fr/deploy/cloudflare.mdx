...
description: "Proxy les requêtes /docs via un Cloudflare Worker vers votre site de documentation Jamdesk. Couvre la configuration du Worker, les patterns de routes et la configuration du cache."
---
