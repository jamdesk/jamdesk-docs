...
Jamdesk gère automatiquement l'ensemble du cycle de vie de build et de déploiement. Il vous suffit d'effectuer un push sur GitHub pour déployer votre documentation en quelques minutes.
...
Jamdesk clone votre repo, valide `docs.json` et la syntaxe MDX, compile en HTML optimisé avec indexation de recherche, avant de déployer sur Cloudflare R2. La plupart des sites sont buildés en 30 à 90 secondes.
