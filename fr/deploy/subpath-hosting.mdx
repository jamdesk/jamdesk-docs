...
<Note>
Activer ou désactiver "Host at a subpath" déclenche une reconstruction automatique de votre documentation. Cela est nécessaire car la structure des URL change entre `/introduction` et `/docs/introduction`.
</Note>
