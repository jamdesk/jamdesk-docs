...
description: "Hébergez vos docs sur yoursite.com/docs plutôt que sur un sous-domaine séparé. Inclut les configurations Vercel, CloudFront, Cloudflare et reverse proxy."
---
