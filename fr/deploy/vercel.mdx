---
title: Vercel
description: Utilisez les rewrites Vercel pour proxier les requêtes de documentation vers Jamdesk. Les rewrites se produisent en périphérie et ne modifient pas l'URL dans le navigateur.
---
