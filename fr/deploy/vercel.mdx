---
title: Vercel
description: "Utilisez les rewrites Vercel pour proxier les requêtes de documentation vers Jamdesk. Les rewrites s'effectuent en périphérie sans modifier l'URL du navigateur."
---
