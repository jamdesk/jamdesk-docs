---
title: Navigation
description: La navigation Jamdesk utilise des onglets, des groupes et des pages pour organiser votre documentation. Des liens externes s'ajoutent via des ancres.
---

La barre latérale et la barre supérieure sont entièrement définies dans `docs.json`. La hiérarchie de navigation comporte trois niveaux — les onglets pour les sections principales, les groupes pour les dossiers repliables, et les pages pour les entrées individuelles — plus des ancres pour les liens externes qui apparaissent sur toutes les pages.
...
<Note>
  Les icônes de la barre latérale s'affichent par défaut dans la variante Font Awesome Solid. Modifiez
  l'épaisseur d'une icône avec un préfixe de style (`light/book`) ou via
  la [forme objet de l'icône](/fr/content/icons#forme-objet-pour-les-icônes).
</Note>
