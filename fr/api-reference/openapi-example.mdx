...
description: Découvrez une page d'endpoint générée en direct depuis OpenAPI et apprenez comment Jamdesk affiche les requêtes, réponses et l'authentification directement depuis votre spec.
...
<Info>
**Documentation multilingue ?** Fournissez un fichier `<spec>.<lang>.<ext>` à côté de votre spec source (par exemple, `example-api.fr.yaml`) et Jamdesk affiche la version traduite lorsque les utilisateurs consultent la page sous `/fr/...`. Voir [Traduire les specs OpenAPI](/fr/setup/languages#translating-openapi-specs).
</Info>
