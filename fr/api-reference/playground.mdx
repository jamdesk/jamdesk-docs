...
description: Testez les endpoints API directement depuis votre documentation avec le playground interactif. Renseignez les paramètres, consultez des exemples de code en direct et envoyez de vraies requêtes.
---
...
<Columns cols={2}>
  ...
  <Card title="Exemples de code" icon="terminal" href="/fr/config/docs-json-reference#api-examples-languages">
