---
title: Blocs de code
description: Ajoutez des blocs de code avec coloration syntaxique, numéros de ligne, noms de fichiers et surlignage ; compatible CodeGroups multilingues.
---
...
Ajoutez `nocopy` pour retirer le bouton de copie d'un bloc unique :
...
Utilisez-le partout où copier le bloc donnerait au lecteur quelque chose qui ne fonctionne pas : une transcription de terminal mêlant invites et sorties, un exemple caviardé, ou un extrait « à ne pas faire ».
