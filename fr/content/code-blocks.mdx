---
title: Blocs de code
description: Ajoutez des blocs de code avec coloration syntaxique, numéros de ligne, noms de fichiers et surlignage. Les CodeGroups gèrent les exemples multilingues.
---

Utilisez des blocs de code pour montrer des commandes, des fichiers de configuration et des extraits avec coloration syntaxique.
...
Ajoutez `nocopy` pour supprimer le bouton de copie d'un bloc spécifique :
...
Utilisez-le partout où copier le bloc donnerait au lecteur quelque chose qui ne fonctionne pas : une transcription de terminal mêlant invites et résultats, un exemple expurgé, ou un extrait « à ne pas faire ».

`nocopy` se combine avec toutes les autres options :
...
<Accordion title="Afficher les thèmes pris en charge">
...
## Thème de variables CSS

Pour un contrôle total sur les couleurs de la coloration syntaxique, utilisez le thème de variables CSS :
...
<Accordion title="Afficher toutes les variables CSS">
