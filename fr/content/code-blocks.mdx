---
title: Blocs de code
description: Ajoutez des blocs de code avec coloration syntaxique, numéros de ligne, noms de fichiers et mise en surbrillance. Prend en charge les CodeGroups pour les exemples multi-langages.
---
