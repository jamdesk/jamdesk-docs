...
Lorsqu'aucune variante n'est spécifiée, les icônes s'affichent dans la variante **Solid**. Remplacez-la par icône avec un préfixe de style (`light/gear`) ou, dans `docs.json`, le champ `style` de la forme objet.
