...
<Tip>
Compressez les vidéos avant de les commiter. Des outils comme [FFmpeg](https://ffmpeg.org/) et [Handbrake](https://handbrake.fr/) peuvent réduire considérablement la taille des fichiers sans perte de qualité visible : `ffmpeg -i input.mp4 -crf 28 -preset slow output.mp4`
</Tip>
