---
title: Extraits de contenu
description: Blocs de contenu réutilisables que vous pouvez importer sur plusieurs pages. Stockez du texte commun, des composants ou du code dans le répertoire snippets.
---
