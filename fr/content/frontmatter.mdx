...
| `private` | boolean | `false` | Exiger le [mot de passe du site](/fr/setup/password-protection) pour afficher cette page. Définir ceci sur n'importe quelle page active le mode pages spécifiques lors du prochain build. |
...
<AccordionGroup>
  ...
  <Accordion title="Rédigez des descriptions utiles" icon="align-left">
    Les descriptions apparaissent dans les résultats de recherche et les previews sociales. Visez 50-160 caractères qui :
