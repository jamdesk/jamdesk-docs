...
<AccordionGroup>
  ...
  <Accordion title="Gardez des fichiers légers" icon="gauge-high">
    ...
    [Squoosh](https://squoosh.app) et [TinyPNG](https://tinypng.com) compressent les images sans perte de qualité visible. Passez vos captures d'écran par l'un de ces outils avant de les commiter.

    Ou laissez Jamdesk s'en charger au moment du build. Activez la [conversion WebP automatique](/fr/builds/image-optimization) dans votre `docs.json` et chaque PNG ou JPG que vous commitez sera optimisé à chaque build.
  </Accordion>
