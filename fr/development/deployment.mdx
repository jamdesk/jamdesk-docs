...
<Columns cols={2}>
  ...
  <Card title="Cycle de vie build et déploiement" icon="rotate" href="/fr/deploy/lifecycle">
  ...
  <Card title="Vue d'ensemble de la CLI" icon="terminal" href="/fr/cli/overview">
