...
description: Démarrez, arrêtez et redémarrez le serveur de développement Jamdesk depuis la barre d'état de Visual Studio Code avec des contrôles en un clic et un aperçu automatique dans le navigateur.
---
