---
title: Preview local
description: "Le CLI Jamdesk vous permet de prévisualiser votre documentation en local avant de pousser en production. Les modifications apparaissent instantanément."
---
