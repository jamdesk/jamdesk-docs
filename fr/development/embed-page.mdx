...
| `data-page` | Chemin | `/changelog` | Tout chemin de docs à ouvrir dans la modale, pas seulement le changelog. Voir [Pointer la modale vers n'importe quelle page](#pointer-la-modale-vers-nimporte-quelle-page). |
