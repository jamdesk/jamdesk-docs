...
| `data-page` | Chemin | `/changelog` | N'importe quel chemin de votre documentation à ouvrir dans la modale, pas seulement le changelog. Voir [Ouvrir n'importe quelle page](#ouvrir-nimporte-quelle-page). |
