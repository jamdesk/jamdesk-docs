...
description: Ajoutez un bouton « Quoi de neuf ? » à votre app pour ouvrir votre changelog Jamdesk en modal, avec un indicateur non lu. Une balise script, sans build.
---
