...
<Steps>
  ...
  <Step title="Connecter votre documentation via MCP">
    ...
    Remplacez `your-project` par votre sous-domaine Jamdesk. Claude peut désormais rechercher et lire directement votre documentation publiée. Voir [Serveur MCP](/fr/ai/mcp-server) pour plus de détails.
  </Step>
