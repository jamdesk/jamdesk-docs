...
description: Maintenez la documentation synchronisée avec votre code grâce au skill /update-jamdesk pour Claude Code. Mettez automatiquement à jour la documentation lorsque vous implémentez des fonctionnalités.
---
...
<Steps>
  ...
  <Step title="Réviser et valider">
    Révisez la documentation générée, puis Claude la vérifiera avec `jamdesk validate` et `jamdesk broken-links` avant de valider.
  </Step>
</Steps>
...
7. **Valide** - Prépare les modifications et propose de les valider/pousser/créer une PR
