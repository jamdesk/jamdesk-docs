---
title: Cursor
description: "Configurez Cursor IDE pour rédiger de la documentation Jamdesk avec des règles de formatage MDX, l'autocomplétion des composants et l'accès au serveur MCP pour le contexte des docs en direct."
---
