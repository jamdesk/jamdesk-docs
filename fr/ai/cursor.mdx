---
title: Cursor
description: "Configurez Cursor IDE pour écrire la documentation Jamdesk avec des règles MDX, l'autocomplétion et l'accès au serveur MCP pour le contexte des docs en direct."
---
