...
Remplacez `your-project` par votre sous-domaine Jamdesk. Consultez [Serveur MCP](/fr/ai/mcp-server) pour les détails du endpoint et la configuration de domaine personnalisé.
