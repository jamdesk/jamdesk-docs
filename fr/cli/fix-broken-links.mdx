...
<Tip>
  Vous préférez rester dans le dashboard ? [Fix with AI](/fr/builds/fix-with-ai) effectue la même correction sur un build, couvre aussi les descriptions de page manquantes et valide les modifications sur GitHub pour vous.
</Tip>
