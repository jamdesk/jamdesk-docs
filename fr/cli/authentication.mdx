...
description: "Connectez-vous, gérez les sessions et comprenez comment le CLI Jamdesk s'authentifie. Couvre le stockage des tokens, le renouvellement des sessions, les comptes d'équipe et les environnements CI/CD."
---
