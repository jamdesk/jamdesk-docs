...
<Steps>
  ...
  <Step title="Télécharger">
    Cliquez sur **Télécharger le PDF**. Consultez [Durée de vie du lien de téléchargement](#dur-e-de-vie-du-lien-de-t-l-chargement) si le lien expire.
  </Step>
</Steps>
...
<Accordion title="La régénération n'a pas produit de nouveau fichier">
  Le PDF en cache a été réutilisé car aucun nouveau build n'est terminé depuis le dernier export. Envoyez un commit, ou cliquez sur **Rebuild** sur la page Builds, puis réessayez la régénération une fois le build terminé. Voir [Mise en cache et Régénération](#mise-en-cache-et-r-g-n-ration).
</Accordion>
