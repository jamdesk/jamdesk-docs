---
title: Background
description: "Pick a decoration (gradient, dot grid, frosted spots, or flat), set the page background color per mode, or tune the Jam gradient's color and size."
---
