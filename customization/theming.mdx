...
Override the theme's font stacks with [Custom CSS](/customization/custom-css#external-fonts). Load any Google Font or self-hosted font, then reassign the `--font-family-sans` and `--font-family-mono` CSS variables.
