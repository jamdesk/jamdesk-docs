---
title: Theming
description: Choose a built-in theme (Jam, Nebula, Pulsar, or Halo) to control typography, layout, spacing, and dark mode. Override colors to match your brand.
---

Set `theme` in `docs.json` to control layout, typography, spacing, and dark mode behavior. Four themes are available: `jam` (default), `nebula`, `pulsar`, and `halo`.
...
<Tip>
Try each theme on these docs before you choose. Pick one under **Preview a theme** at the top of the sidebar. On mobile, open the navigation menu. The preview lasts until you close your browser.
</Tip>
...
<Tabs>
  ...
  <Tab title="Halo" icon="sun">
    ...
    Header-logo layout with Figtree throughout. Warm sand ground (`#F7F2E8`) with the content raised on a card. Heavily rounded (8-28px).

    [View live example](https://halo.jamdesk.com)
