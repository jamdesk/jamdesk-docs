...
<Tabs>
  ...
  <Tab title="Pulsar" icon="bolt">
    ...
    Sidebar-first layout — logo and tabs live in the sidebar, no desktop header. Full-width with 780px centered content. Left-border nav indicators. Inter text, JetBrains Mono code.
