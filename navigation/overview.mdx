...
| **Nested named group** | Collapsed until active, manually opened, or configured with `expanded: true`. Clicking a closed group opens it and clicking an open group closes it; navigation only happens when you click a page. |
