...
| `search` | boolean | `true` | Defina como `false` para excluir a página da busca do site, das respostas do chat de IA e do MCP. Ela continua na barra lateral, no sitemap e no llms.txt. Consulte [Manter uma página fora apenas da busca](/pt/content/hidden-pages#manter-uma-página-fora-da-busca-בלבד) |
