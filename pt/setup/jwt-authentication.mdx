...
Abra apenas os caminhos que as suas páginas públicas realmente usam. Um glob amplo como `/**` abre todos os recursos do site, incluindo as capturas de tela das páginas que você queria reservar a visitantes com sessão iniciada.
