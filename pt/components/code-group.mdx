...
Use em uma aba que não deveria ser copiada como está, como um exemplo de cURL com um token de espaço reservado, deixando copiáveis os exemplos funcionais das outras abas. Consulte [Blocos de código → Ocultar o botão de copiar](/pt/content/code-blocks#ocultar-o-botão-de-copiar) para a marca em um bloco isolado.
