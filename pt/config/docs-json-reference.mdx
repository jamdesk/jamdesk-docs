...
Consulte [Suporte multilíngue → Roteamento automático de idioma](/pt/setup/languages#roteamento-automático-de-idioma) para conhecer o comportamento completo.
