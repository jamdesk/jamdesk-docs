...
Follow the full Jamdesk workflow: create a project, preview locally, deploy to your Jamdesk subdomain, and attach your own custom domain. If you have already completed a step, skip ahead.
