...
description: Optimize docs pages for search and social previews by controlling titles, descriptions, and metadata. Use the examples to keep your docs readable, consistent,.
---

Optimize docs pages for search and social previews by controlling titles, descriptions, and metadata. This guide explains which frontmatter fields Jamdesk reads and how to write metadata that improves discoverability. You will see example snippets and recommended defaults, plus guidance on when this fits into a Jamdesk documentation workflow. If you are new, start with the basic example and expand from there.
