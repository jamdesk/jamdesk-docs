...
<Tip>
**Preview before you publish.** After a build, paste the page URL into an Open Graph preview tool (such as [opengraph.xyz](https://www.opengraph.xyz)) to check how the card renders on each platform.
</Tip>
