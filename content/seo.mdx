...
<Card title="OpenGraph Preview" icon="share-nodes" href="https://jamdesk.com/utilities/opengraph-preview" horizontal>
  See exactly how any page's card renders on X, Facebook, LinkedIn, Slack, Discord, WhatsApp, iMessage, and Google — and validate its Open Graph tags — with our free OpenGraph Preview tool.
</Card>
...
<Tip>
**Preview before you publish.** After a build, paste the page URL into the free [Jamdesk OpenGraph Preview](https://jamdesk.com/utilities/opengraph-preview) tool to see exactly how your card renders on X, Facebook, LinkedIn, Slack, Discord, WhatsApp, iMessage, and Google. It also validates your Open Graph tags, checks image dimensions, and explains how to fix any issues it finds.
</Tip>
