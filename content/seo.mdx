...
<Card title="OpenGraph Preview" icon="share-nodes" href="https://www.jamdesk.com/utilities/opengraph-preview" horizontal>
...
- **Social image** — Set a custom `og:image` on key pages, or rely on the auto-generated card. Verify it with the [OpenGraph Preview](https://www.jamdesk.com/utilities/opengraph-preview) tool.
</Note>
...
<Columns cols={2}>
  ...
  <Card title="OpenGraph Preview Tool" icon="share-nodes" href="https://www.jamdesk.com/utilities/opengraph-preview">
