...
<AccordionGroup>
  ...
  <Accordion title="Keep file sizes small" icon="gauge-high">
    ...
    Or let Jamdesk handle it at build time. Enable [automatic WebP conversion](/builds/image-optimization) in your `docs.json` and any PNG or JPG you commit gets optimized on the way to production.
  </Accordion>
