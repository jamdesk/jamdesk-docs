...
title: Images
description: >-
  Learn how Jamdesk handles image sizing, captions, light/dark variants, and
  supported formats to keep documentation visuals crisp and accessible.
---
...
| SVG | Icons, diagrams, logos | Vector format that scales to any size with zero quality loss. Tiny file size. |
...
<Tip>
WebP gives you the best size-to-quality ratio for most documentation images. If you need transparency, WebP handles that too, so there is no need for PNG.
</Tip>
