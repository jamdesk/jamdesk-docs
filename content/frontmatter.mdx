...
| `lastUpdatedDate` | string | - | Override the "Last updated on" date for this page instead of using its last Git commit date. Quote the value: `"2026-09-01"`. Requires `metadata.timestamp` in `docs.json`. See [Last updated date](#last-updated-date) |
