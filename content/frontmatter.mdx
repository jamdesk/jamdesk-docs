...
Control how the page appears in search results and social previews. Set these as flat top-level keys (Mintlify style) or under a nested `seo:` block. Both work, and per-page values override your `docs.json` `seo.metatags` defaults.
