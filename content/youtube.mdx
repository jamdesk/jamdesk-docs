...
| `title` | `string` | `"YouTube video"` / `"YouTube Short"` | Accessibility label for the embed. Screen readers use this text. |
...
- `youtube.com/shorts/ZoS4HcvotlQ` → ID is `ZoS4HcvotlQ`
