---
title: Math & LaTeX
description: Jamdesk supports LaTeX for rendering mathematical expressions and equations using KaTeX. Math support requires styling.latex: true in your docs.json file.
---
