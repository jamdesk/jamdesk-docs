---
title: MDX Basics
description: MDX lets you write documentation using familiar Markdown syntax while embedding interactive React components. It's the foundation of every Jamdesk page.
---

Every Jamdesk page is an `.mdx` file -- standard Markdown with the ability to drop in JSX components like `<Card>`, `<Tabs>`, or `<Accordion>` wherever you need richer interactivity. Below is a quick reference for the syntax you will use most often.
