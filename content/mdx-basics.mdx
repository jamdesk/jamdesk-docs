---
title: MDX Basics
description: Write documentation using MDX - Markdown with superpowers
---
...
<CardGroup cols={2}>
  ...
  <Card title="Media Embeds" icon="image" href="/content/media-embeds">
    Add images, videos, and embeds
  </Card>
