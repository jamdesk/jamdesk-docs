...
Here's what a signup form looks like to your readers:

<Frame caption="A Jamdesk-hosted signup form, as readers see it on a published docs site">
  ![Signup form titled "Get Jamdesk release notes" with the line "New features and platform changes, straight to your inbox," an email field, and a Subscribe button](/images/email-signups/changelog-signup-form.webp)
</Frame>

You can see one live on the [Jamdesk changelog](/reference/changelog).
...
<Steps>
  <Step title="Open the Email Signups card">
    In the dashboard, open your project and go to **Integrations**. Find the **Email Signups** card.
  </Step>
...
The card has two optional fields, **Form title** and **Form subtitle**, that set the heading and supporting line on auto-placed forms. Leave them blank and the form shows just the field and button; fill them in and changelog forms pick them up on the next publish; no `docs.json` edit is needed.
