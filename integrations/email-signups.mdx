...
Here's what an auto-placed changelog form looks like — its title and supporting line come from the **Form title** and **Form subtitle** fields you set in the dashboard:

<Frame caption="A signup form auto-placed on a changelog page with placement: changelog">
...
You can see this form live on the [Jamdesk changelog](/reference/changelog).
