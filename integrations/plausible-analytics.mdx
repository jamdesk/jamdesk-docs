...
<Accordion title="Not seeing any data in Plausible">
  ...
  2. Check for ad blockers. Some browser extensions block analytics scripts, including Plausible. If that's the cause, switch to the [proxy script setup](#proxy-script-setup-scripturl).
