...
You are responsible for setting up cookie consent banners for any tags you load through Google Tag Manager if you need them—Jamdesk loads your GTM container for all visitors without a consent gate.
