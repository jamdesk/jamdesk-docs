...
Guides for the Jamdesk dashboard and platform — account setup, project management, builds, billing, and integrations. For documentation authoring (MDX, components, deployment), see the [Docs tab](/introduction).
